...

    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'orderlists',
                component: () =>
                    import ('@/views/page/order/orderlists'),
                meta: {
                    title: "我的订单",
            ...
            },
            {
                ...
                name: 'arealists',
                component: () =>
                    import ('@/views/page/common/arealists'),
                meta: {
                    title: "我的订单",
            ...
            },
            {
                ...
                name: 'editevaluate',
                component: () =>
                    import ('@/views/page/order/editevaluate'),
                meta: {
                    title: "评价中心",
            ...
            },
            {
                ...
                name: 'evaluate',
                component: () =>
                    import ('@/views/page/order/evaluate'),
                meta: {
                    title: "评价列表",
...
router.beforeEach((to, from, next) => {
    if (to.name === 'addresslists' && from.name === 'byorder') {
        to.meta.address = 'byorder'
        next();
    } else if (from.name === 'addresslists' && to.name === 'byorder') {
        to.meta.address = 'byorder';
        next();
    } else if (from.name === 'cart' && to.name === 'byorder') {
        to.meta.address = 'cart'
        next();
    } else {
        next();
    }
