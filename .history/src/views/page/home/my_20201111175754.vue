  ...
  <div>
    ...
    <div class="bei">
      ...
      <div v-else>
        <div class="pho">
          <!-- <img :src="userinfo.avatar" alt="" /> -->
          <van-image round src="https://dss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3363295869,2467511306&fm=26&gp=0.jpg" />

          <div>
            <van-button plain hairline type="warning" @click="ulits.to('login')"
              >注册/登录</van-button
            >
          </div>
        </div>
