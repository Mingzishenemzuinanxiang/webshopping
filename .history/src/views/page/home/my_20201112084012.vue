    ...
    <div class="bei">
      <div v-if="userinfo">
        ...
        <div class="pho">
          ...
          <van-image round src="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=911096125,954471894&fm=26&gp=0.jpg" />
      ...
      <div v-else>
        <div class="pho">
          <!-- <img :src="userinfo.avatar" alt="" /> -->
          <van-image round src="https://dss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1141259048,554497535&fm=26&gp=0.jpg" />
