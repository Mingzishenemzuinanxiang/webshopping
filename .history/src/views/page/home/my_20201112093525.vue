  ...
  <div>
    ...
    <div class="biaoti">
      <div class="flex jc-s-aroud">
        ...
        <div>
          <van-icon name="smile-comment-o" size="30" /> <br />
          评价
        </div>
        <div>
          <van-icon name="certificate" size="30" /> <br />
          已完成
        </div>
      </div>
    </div>
    <div class="daohang">
      <van-cell title="全部订单" size="large" icon="description" is-link />
      <van-cell title="收藏商品" size="large" icon="star-o" is-link />
      <van-cell title="地址管理" size="large" icon="location-o" is-link />
      <van-cell title="最近浏览" size="large" icon="eye-o" is-link />
    </div>
  </div>
</template>
