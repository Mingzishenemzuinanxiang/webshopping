  ...
  <div>
    ...
    <div class="biaoti">
      <div class="flex jc-s-aroud">
        ...
        <div>
           <van-icon name="balance-list-o" size="30"/> <br> 待付款
        </div>
        <div>
          <van-icon name="underway-o" size="30"/> <br> 待发货
        </div>
        <div>
          <van-icon name="coupon-o" size="30"/> <br> 待收货
        </div>
        <div>
          <van-icon name="coupon-o" size="30"/> <br> 评价
        </div>
        <div>
          <van-icon name="coupon-o" size="30"/> <br> 已完成
        </div>
      </div>
    </div>
  </div>
