  ...
  <div>
    ...
    >
      ...
      <div>
        <van-row>
          <van-col span="20">
            <!-- <van-button
              ...
              >{{ item }}</van-button
            > -->
            <div v-for="item in history" :key="item" @click="dianji(item)">
              <van-button plain hairline type="default">{{ item }}</van-button>
            </div>
          </van-col>
          <van-col span="4">
            <van-button
        ...
        <van-list>
          <div style="width:100px;heigth:100px" @click="gourl(1)"> 1</div>
          <div
            class="flex via"
            v-if="list.length > 0"
