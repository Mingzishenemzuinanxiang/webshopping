  ...
  <div>
    ...
    >
      ...
      <div>
        <van-row>
          <van-col span="20">
              <van-button plain hairline type="default" v-for="item in history" :key="item" @click="dianji(item)">{{ item }}</van-button>
          </van-col>
          <van-col span="4">
            <van-button
        ...
        <van-list>
           <van-button plain hairline type="default"  v-for="(item, index) in list"  :key="index" @click="gourl(item)"> <div>
              <img :src="item.image" alt="" width="100" height="100" />
            </div>
            <div><span class="font-s" v-html="item.nickname"></span></div></van-button>
