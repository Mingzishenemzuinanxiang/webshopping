  ...
  <div>
    ...
    >
      ...
      <div>
        ...
        >
        <div>
            <div class="flex via" v-if="list.length > 0"  v-for="(item, index) in list" :key="item.name" @click="gourl(item)">
...
.via{
  border-bottom: 1px solid #ccc!important;padding:14px;border-color: #7c7878!important;
}
</style>